...
class TestJsonChecker(TestCase):
    def setUp(self) -> None:
        #tempratuur testen
        self.readeersteFile_temp = JsonChecker(bacteria_name="xx", temperature=10, pH=10, item="temp", inputWaarde=10)
        self.readeersteFile_temp_O2 = JsonChecker(bacteria_name="xx", temperature=4, pH=10, item="temp", inputWaarde=4)
        self.readeersteFile_temp_O3 = JsonChecker(bacteria_name="xx", temperature=37, pH=10, item="temp", inputWaarde=37)
        self.readeersteFile_temp_O4 = JsonChecker(bacteria_name="xx", temperature=45, pH=10, item="temp", inputWaarde=45)
        self.readeersteFile_temp_O5= JsonChecker(bacteria_name="xx", temperature=50, pH=10, item="temp", inputWaarde=50)
        ...
        #ph testen
        self.readeersteFile_pH= JsonChecker(bacteria_name="xx", temperature=10, pH=10, item="ph", inputWaarde=10)
        self.readeersteFile_pH_O2= JsonChecker(bacteria_name="xx", temperature=10, pH=3.5, item="ph", inputWaarde=3.5)
        self.readeersteFile_pH_O3= JsonChecker(bacteria_name="xx", temperature=10, pH=5, item="ph", inputWaarde=5)
        self.readeersteFile_pH_O4= JsonChecker(bacteria_name="xx", temperature=10, pH=4.5, item="ph", inputWaarde=4.5)
        self.readeersteFile_pH_O5= JsonChecker(bacteria_name="xx", temperature=10, pH=20, item="ph", inputWaarde=20)
        ...
        #aw_testen
        self.readeersteFile_aw= JsonChecker(bacteria_name="xx", temperature=10, pH=10, item="aw", inputWaarde=10)
