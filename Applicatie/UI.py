...
from Applicatie.Infobact import InfoBact
from Applicatie.Mainpage import MainPage
from Applicatie.Plotgraph import PlotGraph
from Applicatie.Procesfile import ProcesFile
